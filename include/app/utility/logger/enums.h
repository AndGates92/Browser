...
namespace app {
	...
	namespace logger {
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(info_level_list, app::logger::info_level_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(msg_type_list, app::logger::msg_type_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(state_list, app::logger::state_e)
