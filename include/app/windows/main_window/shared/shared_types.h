...
namespace app {
	...
	namespace main_window {
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(state_postprocessing_list, app::main_window::state_postprocessing_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(state_list, app::main_window::state_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(navigation_type_list, app::main_window::navigation_type_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(text_action_list, app::main_window::text_action_e)
		 ...
		 *
		 */
		OVERLOAD_OPERATORS_CUSTOM_TYPE_FUNCTION_PROTOTYPE(page_type_list, app::main_window::page_type_e)
