...
namespace app {
	...
	namespace base {
		...
		namespace popup {
			 ...
			 *
			 */
			class PopupContainer : public app::base::overlayed_widget::OverlayedWidget {

				Q_OBJECT

				public:
					/**
					 * @brief Function: std::map<unsigned int, std::shared_ptr<app::base::popup::PopupBase>>::size_type getWidgetCount() const
					 *
					 * This function returns the number of widgets in the container
					 */
					std::map<unsigned int, std::shared_ptr<app::base::popup::PopupBase>>::size_type getWidgetCount() const;

					/**
					 * @brief Function: std::shared_ptr<app::base::popup::PopupBase> getWidget(const unsigned int & index) const
					 *
					 ...
					 */
					std::shared_ptr<app::base::popup::PopupBase> getWidget(const unsigned int & index) const;
					...
					/**
					 * @brief Function: virtual std::shared_ptr<app::base::popup::PopupBase> getCurrentWidget() const final
					 *
					 * \return widget shown in the container
					 *
					 * This function returns the widget shown in the container
					 */
					virtual std::shared_ptr<app::base::popup::PopupBase> getCurrentWidget() const final;

					/**
					 * @brief Define methods to get smart pointer from this
					 *
					 */
					SMART_PTR_FROM_THIS_FUNCTIONS(app::base::popup::PopupContainer, app::base::overlayed_widget::OverlayedWidget)
				...
				protected:
					...
					/**
					 * @brief Function: bool addWidget(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 ...
					 */
					bool addWidget(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget);

					/**
					 * @brief Function: unsigned int appendWidget(const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 * \param widget: widget to add
					 *
					 ...
					 */
					unsigned int appendWidget(const std::shared_ptr<app::base::popup::PopupBase> & widget);

					/**
					 * @brief Function: bool replaceWidget(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 ...
					 */
					bool replaceWidget(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget);
					...
					/**
					 * @brief Function: bool removeWidget(const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 ...
					 */
					bool removeWidget(const std::shared_ptr<app::base::popup::PopupBase> & widget);
					...
					/**
					 * @brief Function: bool chooseWidgetToShow(const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 * \param widget: widget to remove
					 *
					 * \return a boolean value indicating whether the shown widget was successfully changed
					 ...
					 */
					bool chooseWidgetToShow(const std::shared_ptr<app::base::popup::PopupBase> & widget);
					...
					/**
					 * @brief Function: std::map<unsigned int, std::shared_ptr<app::base::popup::PopupBase>> & getWidgetMap() const
					 *
					 * This function returns the widget map in the container
					 */
					const std::map<unsigned int, std::shared_ptr<app::base::popup::PopupBase>> & getWidgetMap() const;
				...
				private:
					 ...
					 *
					 */
					std::map<unsigned int, std::shared_ptr<app::base::popup::PopupBase>> popupWidgets;
					...
					/**
					 * @brief Function: void addWidgetToLayout(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget)
					 *
					 ...
					 */
					void addWidgetToLayout(const unsigned int & index, const std::shared_ptr<app::base::popup::PopupBase> & widget);
					 ...
					 */
					void deleteWidgetFromLayout(const std::shared_ptr<app::base::popup::PopupBase> & widget);
