...
logger::Config::Config() : defaultType(logger::msg_type_e::TYPE_LEVEL), defaultVerbosity(logger::info_level_e::INFO_VERBOSITY), defaultContextName("default"), defaultOutputFile(STRINGIFY(LOGFILE)) {
...
CONST_GETTER(logger::Config::getDefaultOutputFile, std::string &, this->defaultOutputFile)
