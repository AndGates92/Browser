...
namespace logger {
	...
	class Context {
		...
		public:
			/**
			 * @brief Function: static logger::Context getDefaultContext(const std::string contextName, const std::string contextFile, const int contextLine, const std::string contextFunction, const logger::msg_type_e contextType, const logger::info_level_e contextInfoVerbosity)
			 *
			...
			/**
			 * @brief Function: void setType(const logger::msg_type_e & value)
			 *
			 ...
			 */
			void setType(const logger::msg_type_e & value);

			/**
			 * @brief Function: const logger::msg_type_e & getType() const
			 *
			 ...
			 */
			const logger::msg_type_e & getType() const;

			/**
			 * @brief Function: void setInfoVerbosity(const logger::info_level_e & value)
			 *
			 ...
			 */
			void setInfoVerbosity(const logger::info_level_e & value);

			/**
			 * @brief Function: const logger::info_level_e & getInfoVerbosity() const
			 *
		...
		private:
			 ...
			 *
			 */
			logger::info_level_e infoVerbosity;
