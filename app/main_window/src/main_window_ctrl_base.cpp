...
main_window_ctrl_base::MainWindowCtrlBase::MainWindowCtrlBase(main_window_core::MainWindowCore * windowCore, QWidget * parent, QString jsonFileName) : parent(parent), mainWindowCore(windowCore), mainWindowState(main_window_shared_types::state_e::IDLE), commands(json_parser::JsonParser(jsonFileName, QIODevice::ReadOnly)) {
