...
main_window_ctrl_base::MainWindowCtrlBase::MainWindowCtrlBase(main_window_core::MainWindowCore * windowCore, QWidget * parent, int tabIndex, int tabCount, QString jsonFileName) : parent(parent), mainWindowCore(windowCore), currentTabIndex(tabIndex), tabCount(tabCount), mainWindowState(main_window_shared_types::state_e::IDLE), commands(json_parser::JsonParser(jsonFileName, QIODevice::ReadOnly)) {
