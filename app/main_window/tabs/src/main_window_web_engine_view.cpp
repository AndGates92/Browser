...
main_window_web_engine_view::MainWindowWebEngineView::MainWindowWebEngineView(const main_window_shared_types::tab_type_e type, const QString & src, const void * data, QWidget * parent): web_engine_view::WebEngineView(parent) {
