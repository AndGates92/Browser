...
main_window_tab::MainWindowTab::MainWindowTab(const main_window_shared_types::tab_type_e type, const void * tabContent, QWidget * parent): tab::Tab(parent) {
	QINFO_PRINT(global_types::qinfo_level_e::ZERO, tabOverall,  "MainWindowTab constructor");

	this->widgetView = new main_window_web_engine_view::MainWindowWebEngineView(type, tabContent, this);
