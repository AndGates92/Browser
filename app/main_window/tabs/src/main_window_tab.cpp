...
main_window_tab::MainWindowTab::MainWindowTab(const main_window_shared_types::page_type_e type, const QString & src, const void * data, QWidget * parent): tab::Tab(parent) {
