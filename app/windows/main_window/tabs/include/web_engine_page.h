...
namespace main_window {
	 ...
	 *
	 */
	class WebEnginePage final : public web_engine_page::WebEnginePage {
		friend class main_window::Tab;
		friend class main_window::WebEngineView;
		...
		public:
			/**
			 * @brief Function: explicit WebEnginePage(QWidget * parent, const main_window::page_type_e & type, const QString & src, web_engine_profile::WebEngineProfile * profile, const void * data = nullptr)
			 *
			 ...
			 */
			explicit WebEnginePage(QWidget * parent, const main_window::page_type_e & type = main_window::page_type_e::UNKNOWN, const QString & src = QString(), main_window::WebEngineProfile * profile = main_window::WebEngineProfile::defaultProfile(), const void * data = nullptr);
			...
			/**
			 * @brief Function: const std::shared_ptr<main_window::PageData> & getData() const
			 *
			 * \return page data
			 *
			 * This function returns custom page data
			 */
			const std::shared_ptr<main_window::PageData> & getData() const;
		...
		private:
			 ...
			 *
			 */
			std::shared_ptr<main_window::PageData> pageData;
			...
			/**
			 * @brief Function: void setData(const std::shared_ptr<main_window::PageData> & newData)
			 *
			 ...
			 */
			void setData(const std::shared_ptr<main_window::PageData> & newData);
