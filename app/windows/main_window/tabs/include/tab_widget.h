...
namespace main_window {
	 ...
	 *
	 */
	class TabWidget final : public tab_widget::TabWidget {
		...
		public:
			...
			/**
			 * @brief Function: int addTab(const main_window::page_type_e & type, const void * data = nullptr, const QIcon & icon = QIcon())
			 *
			 ...
			 */
			int addTab(const main_window::page_type_e & type, const void * data = nullptr, const QIcon & icon = QIcon());

			/**
			 * @brief Function: int insertTab(const int & index, const main_window::page_type_e & type, const void * data = nullptr, const QIcon & icon = QIcon())
			 *
			 ...
			 */
			int insertTab(const int & index, const main_window::page_type_e & type, const void * data = nullptr, const QIcon & icon = QIcon());
			...
			/**
			 * @brief Function: std::shared_ptr<main_window::Tab> widget(const int & index, bool checkError = true)
			 *
			 ...
			 * remove a tab from tab widget
			 */
			std::shared_ptr<main_window::Tab> widget(const int & index, bool checkError = true) const;

			/**
			 * @brief Function: std::shared_ptr<main_window::WebEnginePage> getPage(const int & index) const
			 *
			 ...
			 */
			std::shared_ptr<main_window::WebEnginePage> getPage(const int & index) const;

			/**
			 * @brief Function: void setPageData(const int & index, const std::shared_ptr<main_window::PageData> & pageData)
			 *
			 * \param index: index of the tab to return the type of
			 ...
			 */
			void setPageData(const int & index, const std::shared_ptr<main_window::PageData> & pageData);

			/**
			 * @brief Function: const std::shared_ptr<main_window::PageData> getPageData(const int & index) const
			 *
			 * \param index: index of the tab to return the type of
			 *
			 * \return page data
			 ...
			 */
			const std::shared_ptr<main_window::PageData> getPageData(const int & index) const;

			/**
			 * @brief Function: main_window::page_type_e getPageType(const int & index) const
			 *
			 * \param index: index of the tab to return the type of
			 *
			 ...
			 */
			main_window::page_type_e getPageType(const int & index) const;
			...
			/**
			 * @brief Function: void changePageData(const int & index, const main_window::page_type_e & type, const QString & source, const void * data = nullptr)
			 *
			 ...
			 */
			void changePageData(const int & index, const main_window::page_type_e & type, const QString & source, const void * data = nullptr);

			/**
			 * @brief Function: void changeTabContent(const int & index, const main_window::page_type_e & type, const QString & userInput, const void * data)
			 *
			 * \param index: index to insert tab to
			 ...
			 */
			void changeTabContent(const int & index, const main_window::page_type_e & type, const QString & userInput, const void * data);
			...
			/**
			 * @brief Function: void findInTab(const int & index, const find_settings::FindSettings & settings)
			 *
			...
			/**
			 * @brief Function: void goToHistoryItem(const int & index, const main_window::navigation_type_e & direction)
			 *
			 * \param index: index of the tab
			 ...
			 */
			void goToHistoryItem(const int & index, const main_window::navigation_type_e & direction);
		...
		signals:
			...
			/**
			 * @brief Function: void tabSourceChanged(const main_window::page_type_e & type, const QString & source)
			 *
			 * \param type: type of the tab page
			 ...
			 */
			void tabSourceChanged(const main_window::page_type_e & type, const QString & source);
			...
			/**
			 * @brief Function: void tabUrlChanged(const main_window::page_type_e & type, const QString & url)
			 *
			 * \param type: type of the tab page
			 ...
			 */
			void tabUrlChanged(const main_window::page_type_e & type, const QString & url);

			/**
			 * @brief Function: void searchResultChanged(const main_window::search_data_s & data) const
			 *
			 * \param data: search result data.
			 *
			 * This function is a signal to notify that the search changed
			 */
			void searchResultChanged(const main_window::search_data_s & data) const;
		...
		private:
			...
			/**
			 * @brief Function: QString createSource(const main_window::page_type_e & type, const QString & userInput)
			 *
			 * \param type: type of the tab page
			 * \param userInput: input typed by the user
			 *
			 ...
			 */
			QString createSource(const main_window::page_type_e & type, const QString & userInput);

			/**
			 * @brief Function: QString createLabel(const main_window::page_type_e & type, const QString & userInput)
			 *
			 * \param type: type of the tab page
			 ...
			 */
			QString createLabel(const main_window::page_type_e & type, const QString & userInput);
		...
		private slots:
			...
			/**
			 * @brief Function: void processSearchResultData(const main_window::search_data_s & data) const
			 *
			 * \param data: search result data.
			 *
			 * This function is a slot that receives a notification that the search data changed
			 */
			void processSearchResultData(const main_window::search_data_s & data) const;
