...
namespace main_window {
	 ...
	 *
	 */
	class Tab final : public tab::Tab {
		...
		public:
			...
			/**
			 * @brief Function: std::shared_ptr<main_window::WebEnginePage> getPage() const
			 *
			 * \return tab web page object
			 *
			 * This function returns the page linked to the tab
			 */
			std::shared_ptr<main_window::WebEnginePage> getPage() const;
			...
			/**
			 * @brief Function: void configure(const std::shared_ptr<tab_bar::TabBar> & tabBar, const main_window::page_type_e & type, const QString & src, const void * data)
			 *
			 * \param type: tab type
			 ...
			 */
			void configure(const std::shared_ptr<tab_bar::TabBar> & tabBar, const main_window::page_type_e & type, const QString & src, const void * data);
		...
		private:
			...
			/**
			 * @brief Function: std::shared_ptr<main_window::WebEngineView> getView() const
			 *
			 * \return tab view
			 *
			 * This function returns the tab view
			 */
			std::shared_ptr<main_window::WebEngineView> getView() const;

			/**
			 * @brief Function: std::shared_ptr<main_window::TabLoadManager> getLoadManager() const
			 *
			 * \return load manager
			 *
			 * This function returns the load manager
			 */
			std::shared_ptr<main_window::TabLoadManager> getLoadManager() const;

			/**
			 * @brief Function: std::shared_ptr<main_window::TabSearch> getSearch() const
			 *
			 * \return tab search
			 *
			 * This function returns the tab search
			 */
			std::shared_ptr<main_window::TabSearch> getSearch() const;

			/**
			 * @brief Function: std::shared_ptr<main_window::TabHistory> getHistory() const
			 *
			 * \return history of the tab
			 *
			 * This function returns the history of the page
			 */
			std::shared_ptr<main_window::TabHistory> getHistory() const;

			/**
			 * @brief Function: std::shared_ptr<main_window::WebEngineSettings> getSettings() const
			 *
			 * \return tab settings
			 *
			 * This function returns the settings
			 */
			std::shared_ptr<main_window::WebEngineSettings> getSettings() const;

			/**
			 * @brief Function: std::shared_ptr<main_window::TabScrollManager> getScrollManager() const
			 *
			 * \return scroll manager
			 *
			 * This function returns the scroll manager
			 */
			std::shared_ptr<main_window::TabScrollManager> getScrollManager() const;

			/**
			 * @brief Function: void updateView(const std::shared_ptr<main_window::WebEngineView> & value)
			 *
			 * \param value: view to use
			 *
			 * This function updates the current view as well as informations derived from it
			 */
			void updateView(const std::shared_ptr<main_window::WebEngineView> & value);
			...
			/**
			 * @brief Function: std::shared_ptr<main_window::Tab> shared_from_this()
			 *
			 * \return shared pointer of this
			 *
			 * This function returns a shared pointer to this
			 */
			std::shared_ptr<main_window::Tab> shared_from_this();

			/**
			 * @brief Function: std::weak_ptr<main_window::Tab> sweak_from_this()
			 *
			 * \return weak pointer of this
			 *
			 * This function returns a weak pointer to this
			 */
			std::weak_ptr<main_window::Tab> weak_from_this();
