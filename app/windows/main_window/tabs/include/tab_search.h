...
namespace main_window {
	 ...
	 *
	 */
	class TabSearch final : public tab_search::TabSearch {
		...
		public:
			/**
			 * @brief Function: explicit TabSearch(QWidget * parent, QWidget * attachedTab)
			 *
			 ...
			 */
			explicit TabSearch(QWidget * parent, std::weak_ptr<main_window::Tab> attachedTab);
