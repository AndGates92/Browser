...
namespace main_window {
	 ...
	 *
	 */
	class PageData final : public printable_object::PrintableObject {
		friend class main_window::WebEnginePage;

		public:

			/**
			 * @brief Function: static std::shared_ptr<main_window::PageData> makePageData(const main_window::page_type_e & type, const std::string & src, const void * data)
			 *
			 ...
			 */
			static std::shared_ptr<main_window::PageData> makePageData(const main_window::page_type_e & type, const std::string & src, const void * data);

			/**
			 * @brief Function: PageData(const main_window::page_type_e & pageType, const std::string & src, const void * pageData = nullptr)
			 *
			 ...
			 */
			explicit PageData(const main_window::page_type_e & pageType, const std::string & src, const void * pageData = nullptr);

			// Move and copy constructor
			/**
			 * @brief Function: PageData(const main_window::PageData & rhs)
			 *
			 ...
			 */
			PageData(const main_window::PageData & rhs);

			/**
			 * @brief Function: PageData::PageData(main_window::PageData && rhs)
			 *
			 * \param rhs: class to move
			 *
			 * page data move constructor
			 */
			explicit PageData(main_window::PageData && rhs);

			// Move and copy assignment operators
			/**
			 * @brief Function: PageData & operator=(const main_window::PageData & rhs)
			 *
			 * \param rhs: class to copy
			 *
			 * page data copy assignment operator
			 */
			PageData & operator=(const main_window::PageData & rhs);

			/**
			 * @brief Function: PageData & operator=(main_window::PageData && rhs)
			 *
			 * \param rhs: class to move
			 *
			 * page data move assignment operator
			 */
			PageData & operator=(main_window::PageData && rhs);
			...
			/**
			 * @brief Function: friend bool operator==(const main_window::PageData & rhs)
			 *
			 ...
			 */
			friend bool operator==(const main_window::PageData & lhs, const main_window::PageData & rhs);

			/**
			 * @brief Function: friend bool operator!=(const main_window::PageData & lhs, const main_window::PageData & rhs)
			 *
			 * \param lhs: left side class to compare
			 * \param rhs: right side class to compare
			 *
		...
		private:
			...
			/**
			 * @brief Function: const main_window::page_type_e & getType() const
			 *
			 * \return type field of a page data object
			 *
			 * This functions returns the type field of a page data object
			 */
			const main_window::page_type_e & getType() const;
			...
			/**
			 * @brief Function: void setType(const main_window::page_type_e & value)
			 *
			 * \param value: new type
			 *
			 * This functions sets the type field of a page page data object
			 */
			void setType(const main_window::page_type_e & value);
