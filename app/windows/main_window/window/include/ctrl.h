...
namespace main_window {
	 ...
	 *
	 */
	class Ctrl final : public main_window::CtrlBase {
		...
		public:
			...
			/**
			 * @brief Function: explicit Ctrl(QWidget * parent, const std::shared_ptr<main_window::Core> & core)
			 *
			 ...
			 */
			explicit Ctrl(QWidget * parent, const std::shared_ptr<main_window::Core> & core);
		...
		private:
			...
			/**
			 * @brief Function: virtual bool isValidWindowState(const main_window::state_e & windowState) override
			 *
			 ...
			 */
			virtual bool isValidWindowState(const main_window::state_e & windowState) override;
