...
namespace app {
	...
	namespace main_window {
		...
		namespace window {
			 ...
			 *
			 */
			class MainWindow final : public QMainWindow, public app::main_window::window::Base {
				...
				public:
					...
					/**
					 * @brief Function: const std::unique_ptr<app::main_window::window::CtrlWrapper> & getCtrl() const
					 *
					 * \return window controller
					 *
					 * This method return the window controller
					 */
					const std::unique_ptr<app::main_window::window::CtrlWrapper> & getCtrl() const;
		...
		//			void contextMenuEvent(QContextMenuEvent * event) override;
				...
				private slots:
					...
					/**
					 * @brief Function: void updateWidgetGeometry(const std::shared_ptr<app::base::overlayed_widget::OverlayedWidget> & widget)
					 *
					 * \param widget: widget that is requesting to update its geometry
					 *
					 * This function updates the geometry of an overlayed widget
					 */
					void updateWidgetGeometry(const std::shared_ptr<app::base::overlayed_widget::OverlayedWidget> & widget);
				...
				private:
					 ...
					 *
					 */
					std::unique_ptr<app::main_window::window::CtrlWrapper> ctrl;

					/**
					 * @brief list of overlayed widgets
					 *
					 */
					std::list<std::shared_ptr<app::base::overlayed_widget::OverlayedWidget>> overlayedWidgets;
					...
					/**
					 * @brief Function: void addOverlayedWidget(const std::shared_ptr<app::base::overlayed_widget::OverlayedWidget> & widget)
					 *
					 * \param widget: widget to add
					 *
					 * This function adds a widget to the overlayed widget list
					 */
					void addOverlayedWidget(const std::shared_ptr<app::base::overlayed_widget::OverlayedWidget> & widget);
