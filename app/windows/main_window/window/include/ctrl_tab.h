...
namespace main_window {
	 ...
	 *
	 */
	class CtrlTab final : public main_window::CtrlBase {
		...
		public:
			...
			/**
			 * @brief Function: explicit CtrlTab(QWidget * parent, const std::shared_ptr<main_window::Core> & core)
			 *
			 ...
			 */
			explicit CtrlTab(QWidget * parent, const std::shared_ptr<main_window::Core> & core);
		...
		protected:
			/**
			 * @brief Function: virtual void actionOnReleasedKey(const main_window::state_e & windowState, QKeyEvent * event) override
			 *
			 ...
			 */
			virtual void actionOnReleasedKey(const main_window::state_e & windowState, QKeyEvent * event) override;
		...
		private slots:
			...
			/**
			 * @brief Function: void printSearchResult(const main_window::search_data_s & data) const
			 *
			 * \param data: search result data.
			 *
			 * This function is a slot that receives a notification that the search data changed
			 */
			void printSearchResult(const main_window::search_data_s & data) const;
			...
			/**
			 * @brief Function: void createContentPathTextFromSource(const main_window::page_type_e & type, const QString & source)
			 *
			 ...
			 */
			void createContentPathTextFromSource(const main_window::page_type_e & type, const QString & source);
		...
		private:
			...
			/**
			 * @brief Function: virtual bool isValidWindowState(const main_window::state_e & requestedWindowState) override
			 *
			 ...
			 */
			virtual bool isValidWindowState(const main_window::state_e & requestedWindowState) override;

			/**
			 * @brief Function: virtual void postprocessWindowStateChange(const main_window::state_e & previousState) override
			 *
			 ...
			 */
			virtual void postprocessWindowStateChange(const main_window::state_e & previousState) override;

			/**
			 * @brief Function: void executeActionOnTab(const int & index = main_window::emptyUserInput)
			 *
			 * \param index: index of tab to execute action on
			 *
			 * This function executes action on a based on user input
			 */
			void executeActionOnTab(const int & index = main_window::emptyUserInput);
			...
			/**
			 * @brief Function: void executeTabAction(const int & userInput = main_window::emptyUserInput)
			 *
			 * \param userInput: user input to execute action. If not specified it is default to main_window::emptyUserInput
			 *
			 * This function executes action on a based on user input
			 */
			void executeTabAction(const int & userInput = main_window::emptyUserInput);
			...
			/**
			 * @brief Function: virtual void prepareAction(const main_window::state_e & windowState, QKeyEvent * event) override
			 *
			 * \param windowState: state the window is into.
			 * \param event: key event.
			 *
			 ...
			 */
			virtual void prepareAction(const main_window::state_e & windowState, QKeyEvent * event) override;

			/**
			 * @brief Function: virtual void executeAction(const main_window::state_e & windowState) override
			 *
			 * \param windowState: state the window is into.
			 *
			 * This function executes the actions required when the window is a given state
			 */
			virtual void executeAction(const main_window::state_e & windowState) override;

			// ================================ START ACTIONS ========================================//
			/**
			 * @brief Function: int addNewTab(const main_window::page_type_e & type, , const void * data = nullptr)
			 *
			 ...
			 */
			int addNewTab(const main_window::page_type_e & type, const void * data = nullptr);
			...
			/**
			 * @brief Function: void goToPageInHistory(const main_window::navigation_type_e direction)
			 *
			 * \param direction: direction in the history
			 *
			 * This function goes to a page in the history of the tab
			 */
			void goToPageInHistory(const main_window::navigation_type_e direction);
