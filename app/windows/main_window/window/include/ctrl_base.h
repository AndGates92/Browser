...
namespace main_window {
	 ...
	 *
	 */
	class CtrlBase : public QWidget, public main_window::Base, public main_window::JsonAction {

		Q_OBJECT

		public:
			/**
			 * @brief Function: explicit CtrlBase(QWidget * parent, const std::shared_ptr<main_window::Core> & core, const QString & jsonFileName = QString())
			 *
			 ...
			 */
			explicit CtrlBase(QWidget * parent, const std::shared_ptr<main_window::Core> & core, const QString & jsonFileName = QString());
		...
		signals:
			/**
			 * @brief Function: void windowStateChanged(const main_window::state_e & nextState)
			 *
			 * \param nextState: state the window is requested to go into.
			 *
			 * This function sets the state of window
			 */
			void windowStateChanged(const main_window::state_e & nextState);
		...
		protected:
			...
			/**
			 * @brief Function: virtual void actionOnReleasedKey(const main_window::state_e & windowState, QKeyEvent * event)
			 *
			 ...
			 */
			virtual void actionOnReleasedKey(const main_window::state_e & windowState, QKeyEvent * event) = 0;

			/**
			 * @brief Function: virtual void executeAction(const main_window::state_e & windowState)
			 *
			 * \param windowState: state the window is into.
			 *
			 * This function is abstract and it executes the actions required when the window is a given state
			 */
			virtual void executeAction(const main_window::state_e & windowState) = 0;

			/**
			 * @brief Function: virtual void prepareAction(const main_window::state_e & windowState, QKeyEvent * event)
			 *
			 * \param windowState: state the window is into.
			 * \param event: key event.
			 *
			 ...
			 */
			virtual void prepareAction(const main_window::state_e & windowState, QKeyEvent * event) = 0;

			/**
			 * @brief Function: virtual void postprocessWindowStateChange(const main_window::state_e & previousState)
			 *
			 ...
			 */
			virtual void postprocessWindowStateChange(const main_window::state_e & previousState) = 0;

			/**
			 * @brief Function: virtual void executeCommand(const QString & userCommand, const main_window::state_postprocessing_e & postprocess) final
			 *
			 ...
			 */
			virtual void executeCommand(const QString & userCommand, const main_window::state_postprocessing_e & postprocess) final;

			/**
			 * @brief Function: virtual void changeWindowStateWrapper(const std::unique_ptr<main_window::JsonData> & commandData, const main_window::state_postprocessing_e & postprocess) final
			 *
			 ...
			 */
			virtual void changeWindowStateWrapper(const std::unique_ptr<main_window::JsonData> & commandData, const main_window::state_postprocessing_e & postprocess) final;

			/**
			 * @brief Function: virtual void changeWindowState(const main_window::state_e & nextState, const main_window::state_postprocessing_e postprocess, const Qt::Key key = Qt::Key_unknown) final
			 *
			 * \param nextState: state the window is requested to go into.
			 * \param postprocess: flag to execute post process after chaning state.
			 ...
			 */
			virtual void changeWindowState(const main_window::state_e & nextState, const main_window::state_postprocessing_e postprocess, const Qt::Key key = Qt::Key_unknown) final;

			/**
			 * @brief Function: virtual bool isValidWindowState(const main_window::state_e & windowState)
			 *
			 ...
			 */
			virtual bool isValidWindowState(const main_window::state_e & windowState) = 0;
			...
			/**
			 * @brief Function: void printUserInput(const main_window::text_action_e & action, const QString & text = QString())
			 *
			 ...
			 */
			void printUserInput(const main_window::text_action_e & action, const QString & text = QString());
			...
			/**
			 * @brief Function: void moveToCommandStateFromNonIdleState(const main_window::state_e & windowState, const Qt::Key & key)
			 *
			 * \param nextState: state the window is requested to go into.
			 ...
			 */
			void moveToCommandStateFromNonIdleState(const main_window::state_e & windowState, const Qt::Key & key);
