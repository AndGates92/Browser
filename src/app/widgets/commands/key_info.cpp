...
app::key_info::KeyInfo::KeyInfo(const QKeySequence & keySeq) {
...
app::key_info::KeyInfo::KeyInfo(const app::key_info::KeyInfo & rhs) : key(rhs.key), modifier(rhs.modifier) {

	LOG_INFO(app::logger::info_level_e::ZERO, keyInfoOverall,  "Copy constructor key info");

}

app::key_info::KeyInfo & app::key_info::KeyInfo::operator=(const app::key_info::KeyInfo & rhs) {
...
app::key_info::KeyInfo::KeyInfo(app::key_info::KeyInfo && rhs) : key(std::exchange(rhs.key, Qt::Key_unknown)), modifier(std::exchange(rhs.modifier, Qt::NoModifier)) {

	LOG_INFO(app::logger::info_level_e::ZERO, keyInfoOverall,  "Move constructor key info");

}

app::key_info::KeyInfo & app::key_info::KeyInfo::operator=(app::key_info::KeyInfo && rhs) {
...
app::key_info::KeyInfo::~KeyInfo() {
	LOG_INFO(app::logger::info_level_e::ZERO, keyInfoOverall,  "Destructor of KeyInfo class");

}

QString app::key_info::KeyInfo::toString(QKeySequence::SequenceFormat format) const {
	...
	modifierKeyMap::const_iterator modifierKey = app::key_info::modifierKeys.find(this->key);

	if (modifierKey == app::key_info::modifierKeys.end()) {
...
QString app::key_info::KeyInfo::keyToString(const Qt::Key keyPrint, const QKeySequence::SequenceFormat format) const {
	specialKeyMap::const_iterator specialKey = app::key_info::specialKeys.find(keyPrint);

	QString keyStr = QString();

	// key no found in specialKeys unordered map
	if (specialKey == app::key_info::specialKeys.end()) {
...
QString app::key_info::KeyInfo::modifierToString(const Qt::KeyboardModifier modifierPrint, const QKeySequence::SequenceFormat format) const {
...
bool app::key_info::KeyInfo::isKeyPrintable(const Qt::Key keyCheck) const {
